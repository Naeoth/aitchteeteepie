 ...
 * </p>
 * <ul>
 *   <li>{@link aitchteeteepie.impl.JsonObjectImpl#getMembers <em>Members</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JsonObjectImpl extends JsonTypeImpl implements JsonObject {
	...
	protected EClass eStaticClass() {
		return AitchteeteepiePackage.Literals.JSON_OBJECT;
	}
	...
	public EList<Member> getMembers() {
		if (members == null) {
			members = new EObjectContainmentEList<Member>(Member.class, this, AitchteeteepiePackage.JSON_OBJECT__MEMBERS);
		}
		return members;
	}
