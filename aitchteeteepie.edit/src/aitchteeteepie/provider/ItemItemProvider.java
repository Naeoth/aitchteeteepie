...
/**
 * This is the item provider adapter for a {@link aitchteeteepie.Item} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Item_field_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Item_field_feature", "_UI_Item_type"),
				 AitchteeteepiePackage.Literals.ITEM__FIELD,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Item)object).getField();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Item.class)) {
			case AitchteeteepiePackage.ITEM__FIELD:
